...
*/
$q="codigo_pantalla_mupi VARCHAR(100) NOT NULL PRIMARY KEY, codigo_mupi VARCHAR(100), codigo_pedido INT, codigo_evento VARCHAR(50), foto_real VARCHAR(255), catorcena int(11)";
