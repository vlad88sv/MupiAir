...
*/
$q="codigo_pedido INT NOT NULL AUTO_INCREMENT PRIMARY KEY, codigo VARCHAR(100), catorcena_inicio int(11), catorcena_fin int(11), foto_pantalla VARCHAR(255), costo  INT";
...
*/
$q="Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, codigo_pantalla_mupi VARCHAR(100), codigo_mupi VARCHAR(100), codigo_pedido INT, codigo_evento VARCHAR(50), foto_real VARCHAR(255), catorcena int(11)";
