...
echo '	<script>
		...
		$("#grafico_mapa").load("contenido/mupis+ubicaciones+dinamico.php?accion=mapas&usuario='.$usuario.'&catorcena="+document.getElementsByName(\'combo_catorcenas\')[0].value+"&calle="+$(\'#combo_calles\').val());
		}
		</script>
	';
/*
SCRIPT('
	$("#combo_catorcenas").change(funcion_combo_catorcenas());
	funcion_combo_catorcenas();
');
*/
}
